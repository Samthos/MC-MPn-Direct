...
double MP2F12_V::calculate_v(const Wavefunction& electron_pair_psi1, const Wavefunction& electron_pair_psi2, const Wavefunction& electron_psi, const Electron_Pair_List& electron_pair_list, const Electron_List& electron_list) {
...
void MP2F12_VBX::calculate_bx_t_fa(const std::vector<electron_pair_typ>& electron_pair_list, const std::vector<el_one_typ>& electron_list) {
  for(int ip = 0; ip < electron_pair_list.size();ip++) {
...
void MP2F12_VBX::calculate_bx_t_fb(const std::vector<electron_pair_typ>& electron_pair_list, const std::vector<el_one_typ>& electron_list) {
  for (int io = 0; io < electron_list.size(); ++io) {
...
void MP2F12_VBX::calculate_bx_t_fc(const std::vector<electron_pair_typ>& electron_pair_list, const std::vector<el_one_typ>& electron_list) {
  for(int ip = 0; ip < electron_pair_list.size();ip++) {
    auto f_12 = correlation_factor->calculate_f12(electron_pair_list[ip].r12);
...
void MP2F12_VBX::calculate_bx_t_fd(const std::vector<electron_pair_typ>& electron_pair_list, const std::vector<el_one_typ>& electron_list) {
...
void MP2F12_VBX::calculate_bx_k(const std::vector<electron_pair_typ>& electron_pair_list, const std::vector<el_one_typ>& electron_list) {
  for (int ip = 0; ip < electron_pair_list.size();ip++) {
    std::array<double, 2> t{0.0, 0.0};
    for (int io = 0; io < electron_list.size(); ++io) {
...
double MP2F12_VBX::calculate_bx(const std::vector<electron_pair_typ>& electron_pair_list, const std::vector<el_one_typ>& electron_list) {
...
std::pair<double, double> MP2F12_VBX::calculate_v_vbx(const std::vector<electron_pair_typ>& electron_pair_list, const std::vector<el_one_typ>& electron_list) {
