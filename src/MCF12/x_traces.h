...
class X_Traces {
 ...
 public:
  ...
  void set_derivative_traces(int band, int offBand, std::unordered_map<int, Wavefunction_Type>& wavefunctions, const Electron_Pair_List_Type* electron_pair_list, const Electron_List_Type* electron_list);
  void set_fd_derivative_traces(int band, int offBand, std::unordered_map<int, Wavefunction_Type>& wavefunctions, const Electron_Pair_List_Type* electron_pair_list, const Electron_List_Type* electron_list);
