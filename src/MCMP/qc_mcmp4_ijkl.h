...
en[6] = ovps.o_set[2][0].s_12[il] * ovps.v_set[2][0].s_11[il] * ovps.v_set[2][1].s_22[jl] * ovps.o_set[2][2].s_11[kl];
en[7] = ovps.o_set[2][0].s_12[il] * ovps.v_set[2][0].s_12[il] * ovps.v_set[2][1].s_11[jl] * ovps.o_set[2][2].s_11[kl];
en[8] = ovps.o_set[2][0].s_12[il] * ovps.v_set[2][0].s_12[il] * ovps.v_set[2][1].s_21[jl] * ovps.o_set[2][2].s_11[kl];
en[9] = ovps.o_set[2][0].s_12[il] * ovps.v_set[2][0].s_21[il] * ovps.v_set[2][1].s_12[jl] * ovps.o_set[2][2].s_11[kl];
en[10] = ovps.o_set[2][0].s_12[il] * ovps.v_set[2][0].s_21[il] * ovps.v_set[2][1].s_22[jl] * ovps.o_set[2][2].s_11[kl];
en[11] = ovps.o_set[2][0].s_12[il] * ovps.v_set[2][0].s_22[il] * ovps.v_set[2][1].s_11[jl] * ovps.o_set[2][2].s_11[kl];
en[12] = ovps.o_set[2][0].s_12[il] * ovps.v_set[2][0].s_22[il] * ovps.v_set[2][1].s_21[jl] * ovps.o_set[2][2].s_11[kl];
...
en[23] = ovps.o_set[2][1].s_12[jl] * ovps.v_set[2][1].s_12[jl] * ovps.v_set[2][0].s_21[il] * ovps.o_set[2][2].s_11[kl];
en[24] = ovps.o_set[2][1].s_12[jl] * ovps.v_set[2][1].s_22[jl] * ovps.v_set[2][0].s_21[il] * ovps.o_set[2][2].s_11[kl];
en[25] = ovps.o_set[2][1].s_12[jl] * ovps.v_set[2][1].s_11[jl] * ovps.v_set[2][0].s_22[il] * ovps.o_set[2][2].s_11[kl];
en[26] = ovps.o_set[2][1].s_12[jl] * ovps.v_set[2][1].s_21[jl] * ovps.v_set[2][0].s_22[il] * ovps.o_set[2][2].s_11[kl];
